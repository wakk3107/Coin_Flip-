...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PlayScene_t, stringdata) + ofs \
...
const QMetaObject PlayScene::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_PlayScene.data,
      qt_meta_data_PlayScene,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PlayScene.stringdata))
